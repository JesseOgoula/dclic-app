...
import { BarChart3, Target, LogOut, ArrowRight, ShieldCheck, Sun, Moon, Sparkles } from 'lucide-react';
      ...
      <div className="w-full max-w-4xl space-y-8 animate-fade-in">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-muted border border-border text-xs font-medium text-muted-foreground mb-2">
            ...
            <span>Espace Coordinateur & Évaluation</span>
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Plateforme de Suivi DCLIC</h1>
          <p className="text-sm text-muted-foreground max-w-lg mx-auto">
            Sélectionnez le parcours pour piloter les cohortes, évaluer les livrables avec l'Agent IA et surveiller l'avancement.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <CardHeader className="pb-3">
              <div className="flex justify-between items-start">
                ...
                <Badge variant="outline" className="bg-primary/10 text-primary border-primary/20 text-xs font-medium flex items-center gap-1">
                  <Sparkles className="w-3 h-3" />
                  Formation & Projet Pro
                </Badge>
              </div>
              ...
              <CardDescription className="text-xs text-muted-foreground leading-relaxed mt-1.5">
                Formation socle (5 séquences Moodle) et supervision intégrée des 6 livrables du Projet Professionnel avec correction par Agent IA.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-2">
              <div className="flex items-center justify-between text-xs text-muted-foreground bg-muted/60 px-3 py-2.5 rounded-lg border border-border/60">
                ...
                <span className="font-medium text-foreground">115 apprenants · 39 projets</span>
              </div>
              <div className="mt-4 flex items-center gap-1.5 text-xs font-medium text-foreground/80 group-hover:text-foreground transition-colors">
                <span>Accéder au parcours complet</span>
          ...
          >
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-xs text-muted-foreground leading-relaxed mt-1.5">
                Spécialisation 360° — 5 séquences opérationnelles, ateliers pratiques et suivi de progression de cohorte.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-2">
              <div className="flex items-center justify-between text-xs text-muted-foreground bg-muted/60 px-3 py-2.5 rounded-lg border border-border/60">
